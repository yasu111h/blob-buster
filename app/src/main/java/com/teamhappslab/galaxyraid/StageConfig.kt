...
data class StageConfig(
    ...
    companion object {
        ...
        // stage / bossLv / 敵上限 / HP倍 / 攻撃間隔倍 / 速度倍 / ボスHP / 最終P / ボス攻撃倍 / 道中回復Lv / 道中量 / ボス前量
        private val STAGES = listOf(
            StageConfig(1, 20, BlobSize.LARGE,  0.6f,  1.5f,  0.85f,  320, 1, 1.5f,  10, 99, 99),
            StageConfig(2, 23, BlobSize.HUGE,   0.75f, 1.3f,  0.9f,   480, 2, 1.25f,  0,  0,  2),
            StageConfig(3, 27, BlobSize.DRAGON, 0.9f,  1.15f, 1.0f,   650, 3, 1.1f,   0,  0,  1),
            StageConfig(4, 32, BlobSize.ENEMY8, 1.0f,  1.0f,  1.0f,   900, 3, 1.0f,   0,  0,  0),
            StageConfig(5, 40, BlobSize.ENEMY8, 1.2f,  0.85f, 1.1f,  1150, 3, 0.85f,  0,  0,  0),
        )
